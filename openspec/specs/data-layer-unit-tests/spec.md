...
Ensure that pure helper functions extracted from the server data layer and error-mapping utilities are covered by unit tests, verifying correctness of date math, splitting logic, and HTTP status mapping.
