...
Both are loved, both are here to stay. But the boundary between them has accumulated four friction points that cost us capability, code quality, and developer trust:
...
This change addresses all four. It is architectural, not feature work: better same-code, no new user-visible capabilities.
